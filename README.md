...
Click a marked word and its explanation opens in the margin. The eight hardest
terms are explained up front so the first click is instant.

**Look up one word.** Type or dictate a single term and get the same gloss.
...
The gloss gives a short definition, key facts, a summary, related terms you can
jump to, categories, source links, and when the source was last edited.
